...
class MEModel(LCSBModel, Model):
    ...
    def _constrain_polymerase(self, the_gene,
        ...
        is_CRISPR_AID_factor = False
        non_aid_variable = None
        non_aid_variable_min = None
        ...
        if is_CRISPR_AID_factor:
            rnap_alloc = rnap_alloc - non_aid_variable
        ...
        if is_CRISPR_AID_factor:
            min_alloc = min_alloc - non_aid_variable_min
